...
!function(e) {
    ...
    e((function() {
        ...
        function(t) {
            ...
            columns: 3
        }], "rc-mb-0"], [["#about", ".pricing-section .single-plan", null], [{
            matchMedia: "(max-width: 991.98px)",
            columns: 1
        }, {
            matchMedia: "(min-width: 991.98px)",
            columns: 3
        }], "rc-mb-0"], [["#portfolio", ".portfolio-section .single-item .portfolio-item", ".portfolio-wrapper"], [{
            matchMedia: "(max-width: 991.98px)",
            columns: 2
        }, {
            matchMedia: "(min-width: 991.98px)",
            columns: 3
        }], "rc-mb-0"], [["#blog", ".blog-section .single-post", null], [{
            matchMedia: "(max-width: 991.98px)",
            columns: 1
        }, {
            matchMedia: "(min-width: 991.98px)",
            ...
            var t = function() {
                e("#resume .skills-section .single-skill").each((function() {
                    var t = Math.min(100, Math.max(0, e(this).data("percentage")))
                      ...
                      , a = i - i * (t / 100);
                    e(this).find(".skill-percentage").text(t + "%").css("margin-right", a),
                    e(this).find(".progress-bar").attr("aria-valuenow", t).css("width", t + "%")
                }
                ))
            };
            t(),
