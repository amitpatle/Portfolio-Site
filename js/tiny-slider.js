var tns = function() {
    ...
    function C(t, e) {
        if (t = b(t) || t instanceof Array ? t : [t],
    ...
    var R = function(t) {
        ...
        if (B) {
            var S = navigator.userAgent
              , O = new Date;
            try {
                (b = l.localStorage) ? (b.setItem(O, O),
                B = b.getItem(O) == O,
                b.removeItem(O)) : B = !1,
                B || (b = {})
            } catch (S) {
            ...
            B && (b.tnsApp && b.tnsApp !== S && ["tC", "tPL", "tMQ", "tTf", "t3D", "tTDu", "tTDe", "tADu", "tADe", "tTE", "tAE"].forEach((function(t) {
                b.removeItem(t)
            }
            )),
            localStorage.tnsApp = S)
        }
        var I, P, z, W, F, q, j, V = b.tC ? r(b.tC) : o(b, "tC", function() {
            var t = document
              , e = u()
              , n = s(e)
            ...
            a
        }(), B), G = b.tPL ? r(b.tPL) : o(b, "tPL", function() {
            ...
            t
        }(), B), Q = b.tMQ ? r(b.tMQ) : o(b, "tMQ", (P = document,
        W = s(z = u()),
        ...
        "absolute" === I), B), X = b.tTf ? r(b.tTf) : o(b, "tTf", A("transform"), B), Y = b.t3D ? r(b.t3D) : o(b, "t3D", function(t) {
            if (!t)
                return !1;
        ...
        }(X), B), K = b.tTDu ? r(b.tTDu) : o(b, "tTDu", A("transitionDuration"), B), J = b.tTDe ? r(b.tTDe) : o(b, "tTDe", A("transitionDelay"), B), U = b.tADu ? r(b.tADu) : o(b, "tADu", A("animationDuration"), B), _ = b.tADe ? r(b.tADe) : o(b, "tADe", A("animationDelay"), B), Z = b.tTE ? r(b.tTE) : o(b, "tTE", L(K, "Transition"), B), $ = b.tAE ? r(b.tAE) : o(b, "tAE", L(U, "Animation"), B), tt = l.console && "function" == typeof l.console.warn, et = ["container", "controlsContainer", "prevButton", "nextButton", "navContainer", "autoplayButton"], nt = {};
        ...
        !(t.container.children.length < 1)) {
            ...
            var vt, pt, ht = "horizontal" === t.axis, mt = n.createElement("div"), yt = n.createElement("div"), gt = t.container, xt = gt.parentNode, bt = gt.outerHTML, Ct = gt.children, wt = Ct.length, Mt = In(), Tt = !1;
            it && ni(),
            rt && (gt.className += " tns-vpfix");
            var Et, Nt, At, Lt, Bt, St, Ot, Dt = t.autoWidth, Ht = Fn("fixedWidth"), kt = Fn("edgePadding"), Rt = Fn("gutter"), It = zn(), Pt = Fn("center"), zt = Dt ? 1 : Math.floor(Fn("items")), Wt = Fn("slideBy"), Ft = t.viewportMax || t.fixedWidthViewportWidth, qt = Fn("arrowKeys"), jt = Fn("speed"), Vt = t.rewind, Gt = !Vt && t.loop, Qt = Fn("autoHeight"), Xt = Fn("controls"), Yt = Fn("controlsText"), Kt = Fn("nav"), Jt = Fn("touch"), Ut = Fn("mouseDrag"), _t = Fn("autoplay"), Zt = Fn("autoplayTimeout"), $t = Fn("autoplayText"), te = Fn("autoplayHoverPause"), ee = Fn("autoplayResetOnVisibility"), ne = (Ot = document.createElement("style"),
            document.querySelector("head").appendChild(Ot),
            Ot.sheet ? Ot.sheet : Ot.styleSheet), ie = t.lazyload, ae = (t.lazyloadSelector,
            []), re = Gt ? (Bt = function() {
                if (Dt || Ht && !Ft)
                    return wt - 1;
                var e = Ht ? "fixedWidth" : "items"
                  , n = [];
                if ((Ht || t[e] < wt) && n.push(t[e]),
                it)
                    for (var i in it) {
                        var a = it[i][e];
                        a && (Ht || a < wt) && n.push(a)
            ...
            St = Math.max(Bt, St),
            Wn("edgePadding") ? St + 1 : St) : 0, oe = rt ? wt + 2 * re : wt + re, ue = !(!Ht && !Dt || Gt), le = Ht ? Bi() : null, se = !rt || !Gt, ce = ht ? "left" : "top", fe = "", de = "", ve = Ht ? function() {
            ...
            , pe = Hn(Fn("startIndex")), he = pe, me = (Dn(),
            0), ye = Dt ? null : ve(), ge = t.preventActionWhenRunning, xe = t.swipeAngle, be = !xe || "?", Ce = !1, we = t.onInit, Me = new k, Te = " tns-slider tns-" + t.mode, Ee = gt.id || (Lt = window.tnsId,
            window.tnsId = Lt ? Lt + 1 : 1,
            "tns" + window.tnsId), Ne = Fn("disable"), Ae = !1, Le = t.freezable, Be = !(!Le || Dt) && ei(), Se = !1, Oe = {
                click: zi,
                keydown: function(t) {
                    t = Xi(t);
                ...
                mouseup: $i,
                mouseleave: $i
            }, ze = Wn("controls"), We = Wn("nav"), Fe = !!Dt || t.navAsThumbnails, qe = Wn("autoplay"), je = Wn("touch"), Ve = Wn("mouseDrag"), Ge = "tns-slide-active", Qe = "tns-complete", Xe = {
                load: function(t) {
                    fi(Yi(t))
                },
                error: function(t) {
            ...
            if (ze)
                var Ke, Je, Ue = t.controlsContainer, _e = t.controlsContainer ? t.controlsContainer.outerHTML : "", Ze = t.prevButton, $e = t.nextButton, tn = t.prevButton ? t.prevButton.outerHTML : "", en = t.nextButton ? t.nextButton.outerHTML : "";
            if (We)
                var nn, an = t.navContainer, rn = t.navContainer ? t.navContainer.outerHTML : "", on = Dt ? wt : ea(), un = 0, ln = -1, sn = Rn(), cn = sn, fn = "tns-nav-active", dn = "Carousel Page ", vn = " (Current Slide)";
            if (qe)
                var pn, hn, mn, yn, gn, xn = "forward" === t.autoplayDirection ? 1 : -1, bn = t.autoplayButton, Cn = t.autoplayButton ? t.autoplayButton.outerHTML : "", wn = ["<span class='tns-visually-hidden'>", " animation</span>"];
            if (je || Ve)
                var Mn, Tn, En = {}, Nn = {}, An = !1, Ln = ht ? function(t, e) {
                    return t.x - e.x
                }
                : function(t, e) {
                    return t.y - e.y
            ...
            function() {
                if (!rt)
                    for (var e = pe, n = pe + Math.min(wt, zt); e < n; e++) {
                        var i = Ct[e];
                        i.style.left = 100 * (e - pe) / zt + "%",
                        m(i, st),
                        y(i, dt)
                    }
                if (ht && (G || Dt ? (f(ne, "#" + Ee + " > .tns-item", "font-size:" + l.getComputedStyle(Ct[0]).fontSize + ";", d(ne)),
                f(ne, "#" + Ee, "font-size:0;", d(ne))) : rt && v(Ct, (function(t, e) {
                    var n;
                    t.style.marginLeft = (n = e,
                    V ? V + "(" + 100 * n + "% / " + oe + ")" : 100 * n / oe + "%")
                }
                ))),
                Q) {
                    if (K) {
                    ...
                    f(ne, "#" + Ee + "-iw", a, d(ne)),
                    rt && (a = ht && !Dt ? "width:" + jn(t.fixedWidth, t.gutter, t.items) + ";" : "",
                    K && (a += Xn(jt)),
                    f(ne, "#" + Ee, a, d(ne))),
            ...
            Kn();
            var Bn = Gt ? rt ? function() {
                var t = me
                  , e = ye;
                t += Wt,
                e -= Wt,
                kt ? (t += 1,
                e -= 1) : Ht && (It + Rt) % (Ht + Rt) && (e -= 1),
            ...
            return {
                ...
                destroy: function() {
                    ...
                    et = st = ct = ft = dt = ht = mt = yt = gt = xt = bt = Ct = wt = pt = Mt = Dt = Ht = kt = Rt = It = zt = Wt = Ft = qt = jt = Vt = Gt = Qt = ne = ie = Et = ae = re = oe = ue = le = se = ce = fe = de = ve = pe = he = me = ye = xe = be = Ce = we = Me = Te = Ee = Ne = Ae = Le = Be = Se = Oe = De = He = ke = Re = Ie = Pe = ze = We = Fe = qe = je = Ve = Ge = Qe = Xe = Nt = Xt = Yt = Ue = _e = Ze = $e = Ke = Je = Kt = an = rn = nn = on = un = ln = sn = cn = fn = dn = vn = _t = Zt = xn = $t = te = bn = Cn = ee = wn = pn = hn = mn = yn = gn = En = Nn = Mn = An = Tn = Ln = Jt = Ut = null,
                    this)
        ...
        function Rn() {
            var t, e = kn();
            return t = Fe ? e : Ht || Dt ? Math.ceil((e + 1) * on / wt - 1) : Math.floor(e / zt),
            !Gt && rt && pe === ye && (t = on - 1),
            t
        }
        function In() {
        ...
        function Kn() {
            if (Wn("autoHeight") || Dt || !ht) {
                ...
                v(t, (function(t) {
                    var e = t.src;
                    e && e.indexOf("data:image") < 0 ? (D(t, Xe),
                    t.src = "",
                    t.src = e,
                    m(t, "loading")) : ie || fi(t)
                }
        ...
        function Jn() {
            if (Dt) {
                var t = Gt ? pe : wt - 1;
                !function e() {
                    Ct[t - 1].getBoundingClientRect().right.toFixed(2) === Ct[t].getBoundingClientRect().left.toFixed(2) ? Un() : setTimeout((function() {
                        e()
                    }
                    ), 16)
                }()
        ...
        function _n() {
            ...
            qe) {
                ...
                bn ? C(bn, {
                    "data-action": e
                }) : t.autoplayButtonOutput && (mt.insertAdjacentHTML(Pn(t.autoplayPosition), '<button data-action="' + e + '">' + wn[0] + e + wn[1] + $t[0] + "</button>"),
            ...
            if (We) {
                if (an)
                    ...
                    for (var n = "", i = Fe ? "" : 'style="display:none"', a = 0; a < wt; a++)
                        n += '<button data-nav="' + a + '" tabindex="-1" aria-controls="' + Ee + '" ' + i + ' aria-label="' + dn + (a + 1) + '"></button>';
            ...
            ze && (Ue || Ze && $e || (mt.insertAdjacentHTML(Pn(t.controlsPosition), '<div class="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button data-controls="prev" tabindex="-1" aria-controls="' + Ee + '">' + Yt[0] + '</button><button data-controls="next" tabindex="-1" aria-controls="' + Ee + '">' + Yt[1] + "</button></div>"),
            Ue = mt.querySelector(".tns-controls")),
            Ze && $e || (Ze = Ue.children[0],
            $e = Ue.children[1]),
            t.controlsContainer && C(Ue, {
                "aria-label": "Carousel Navigation",
                tabindex: "0"
            }),
            (t.controlsContainer || t.prevButton && t.nextButton) && C([Ze, $e], {
                "aria-controls": Ee,
                tabindex: "-1"
            }),
            (t.controlsContainer || t.prevButton && t.nextButton) && (C(Ze, {
                "data-controls": "prev"
            }),
            C($e, {
                "data-controls": "next"
        ...
        function Zn() {
            ...
            Ut && D(gt, Pe),
            qt && D(n, Re),
            "inner" === at ? Me.on("outerResized", (function() {
                ti(),
                Me.emit("innerLoaded", ia())
            }
            )) : (it || Ht || Dt || Qt || !ht) && D(l, {
                resize: $n
            }),
        ...
        function ti(e) {
            if (Tt) {
                "outer" === at && Me.emit("outerResized", ia(e)),
                Mt = In();
                var i, a = pt, r = !1;
                it && (ni(),
                (i = a !== pt) && Me.emit("newBreakpointStart", ia(e)));
                var o, u, l, s, c = zt, p = Ne, h = Be, g = qt, x = Xt, b = Kt, C = Jt, w = Ut, M = _t, N = te, A = ee, L = pe;
                if (i) {
                    var B = Ht
                      , S = Qt
                      , O = Yt
                ...
                Le && (i || Ht || Dt) && (Be = ei()) !== h && (Be ? (Di(Si(Hn(0))),
                ri()) : (function() {
                    if (Se) {
                ...
                Xt !== x && (Xt ? Ue ? E(Ue) : (Ze && E(Ze),
                $e && E($e)) : Ue ? T(Ue) : (Ze && T(Ze),
                $e && T($e))),
                Kt !== b && (Kt ? E(an) : T(an)),
                ...
                if ((u || Ht && !Dt) && (on = ea(),
                na()),
                (o = pe !== L) ? (Me.emit("indexChanged", ia()),
                r = !0) : u ? o || mi() : (Ht || Dt) && (ci(),
                Ci(),
                ui()),
                u && !rt && function() {
                ...
                !Ne && !Be) {
                    if (i && !Q && (Qt === autoheightTem && jt === speedTem || yi(),
        ...
        function ei() {
            ...
            var t = Ht ? (Ht + Rt) * wt : Et[wt]
              , e = kt ? It + 2 * kt : It + Rt;
            return Pt && (e -= Ht ? (It - Ht) / 2 : (It - (Et[pe + 1] - Et[pe] - Rt)) / 2),
            t <= e
        }
        function ni() {
            for (var t in pt = 0,
        ...
        function si(t) {
            ...
            i = n + It + 2 * kt) : Dt && (n = Et[pe],
            i = n + It),
            Dt)
                Et.forEach((function(t, r) {
                    r < oe && ((Pt || kt) && t <= n + .5 && (a = r),
                    .5 <= i - t && (e = r))
                }
                ));
            else {
        ...
        function ci() {
            ie && !Ne && vi.apply(null, si()).forEach((function(t) {
                if (!h(t, Qe)) {
                    var e = {};
                    e[Z] = function(t) {
                        t.stopPropagation()
        ...
        function Bi() {
            ...
            return Pt && !Gt && (t = Ht ? -(Ht + Rt) * (oe - 1) - Li() : Li(oe - 1) - Et[oe - 1]),
            0 < t && (t = 0),
            t
        }
        function Si(t) {
        ...
        function ki(t, e) {
            se && Bn(),
            (pe !== he || e) && (Me.emit("indexChanged", ia()),
        ...
        function _i(t) {
            ...
            Nn.x = En.x = e.clientX,
            Nn.y = En.y = e.clientY,
            rt && (Mn = parseFloat(gt.style[ce].replace(fe, "")),
            Ai(gt, "0s"))
        }
        function Zi(t) {
            if (An) {
            ...
            if (An) {
                ...
                if (Math.abs(r)) {
                    ...
                    rt ? Tn = e((function() {
                        ...
                        ki(n, r),
                        Me.emit(Ki(n) ? "touchEnd" : "dragEnd", ia(n))
                    }
                    )) : be && zi(n, 0 < r ? -1 : 1)
                }
            }
